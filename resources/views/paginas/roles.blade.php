            ...
            <tr>
                ...
                <td class="w-44">
                    <div class="flex justify-evenly">
                        <a href="{{route("Roles.show",$rol->id)}}" title="Editar Rol">
                        ...
                        <a href="{{ route('Roles.showAddUser', $rol) }}" title="Añadir Usuario">
                        ...
                        <a href="{{ route('Roles.showAllUsers', $rol)  }}" title="Listado Usuarios">
    ...
    @if(isset($rolAddUser))
        <div class="w-80 h-full float-right mt-5 ">
            <form action="{{route('profile.update')}}" method="POST" class="rounded-2xl bg-white shadow-md pt-6 pb-8 mb-4 flex flex-col items-center justify-center">
                ...
                <x-text-input class="mt-3" type="text" name="nameRol" value="{{$rolAddUser->nombre}}"/>
    ...
    @if(isset($rolMod))
        <div class="w-80 h-full float-right mt-5 ">
            <form action="{{route('Roles.update', $rolMod[0]->id)}}" method="POST" class="rounded-2xl bg-white shadow-md pt-6 pb-8 mb-4 flex flex-col items-center justify-center">
                ...
                @csrf
                @method('PUT')
                <x-text-input class="mt-3" type="text" name="nombre" value="{{$rolMod[0]->nombre}}" placeholder="Nombre"/>
                <x-input-error class="mt-2" :messages="$errors->get('nombre')" /><br>
