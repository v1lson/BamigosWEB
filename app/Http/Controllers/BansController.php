...
class BansController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $ban = new Bans;
            $timestamp = time();
            $ban->fill(["estado"=>0,"id_servidor"=>$servidorId,"steam_id"=>$steamId,"nombre"=>$nombre,"tiempo_inicio"=>$timestamp,"tiempo_final"=>$timestamp+$periodo,"razon"=>$razon,"nombre_moderador"=>$moderador]);
            $ban->save();
        }
        catch( Exception $e ){
