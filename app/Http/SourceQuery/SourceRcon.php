...
namespace App\Http\SourceQuery;

use App\Http\SourceQuery\Exception\AuthenticationException;
use App\Http\SourceQuery\Exception\InvalidPacketException;
use App\Http\SourceQuery\Exception\SocketException;
	...
	class SourceRcon
	{
		...
		public function Write( int $Header, string $String = '' ) : bool
		{
			...
			$Command = SourceRcon . phppack('VV', ++$this->RconRequestId, $Header) . $String . "\x00\x00";

			// Prepend packet length
			$Command = SourceRcon . phppack('V', strlen($Command)) . $Command;
